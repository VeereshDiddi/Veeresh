...
-(void)startPlayer{
    ...
    if(networkStatus != NotReachable){
        if (urlLink != nil){
            ...
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.qezyplay.com"]];
...
-(void) updateServerStatus
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://qezyplay.com/mobile_detect/updatesessionbyapp.php?action=addanalytics"];
