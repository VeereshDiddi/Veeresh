...
- (void) willExitFullscreen: (NSNotification *) notify
{
...
#ifdef ALERT_EXIT
    if (self.mediaPlayer.playbackState == MPMoviePlaybackStatePaused)
    {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Exit Qezy-TV and back to Safari" message:nil delegate:nil cancelButtonTitle:@"Cancel" otherButtonTitles:@"Ok", nil];
