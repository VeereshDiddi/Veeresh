...
- (void)appplicationIsActive:(NSNotification *)notification {
    ...
    if(self.sfvc != nil)
        [self.sfvc dismissViewControllerAnimated:true completion: nil];
}
...
-(void)startPlayer{
    ...
    if(networkStatus != NotReachable){
        if (urlLink != nil){
            ...
            NSLog(@"From webpage, Play Channel %@ %@",  urlLink, webUrl);
            ...
            if ([SFSafariViewController class] != nil) {
                NSLog(@"open safari view controller");
                
                if (webUrl == nil)
                    self.sfvc = [[SFSafariViewController alloc] initWithURL:[NSURL URLWithString:@"http://www.qezyplay.com"]];
                else
                    self.sfvc = [[SFSafariViewController alloc] initWithURL:[NSURL URLWithString:webUrl]];
...
-(void) updateServerStatus
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.qezyplay.com/mobile_detect/updatesessionbyapp.php?action=addanalytics"];
