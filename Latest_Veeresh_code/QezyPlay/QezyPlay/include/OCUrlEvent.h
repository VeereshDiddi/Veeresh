 ...
 * \deprecated this method is deprecated since iOS 9, you should use AVPlayer instead of MPMoviePlayerController.
 */

-(void) registerMPMoviePlayerController:(MPMoviePlayerController*) mp __deprecated;

/**
 * On this listener a AVPlayer reference must be registered, after AVPlayer was initialized with the URL.
 */
-(void) registerAVPlayer:(AVPlayer*) avPlayer;
