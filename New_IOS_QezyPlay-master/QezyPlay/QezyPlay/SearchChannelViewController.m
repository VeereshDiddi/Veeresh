...
-(void)searchBar:(UISearchBar*)searchBar textDidChange:(NSString*)text
{
    ...
    //Channel Not Found.
    if(self.filteredTableData.count == 0 && text.length !=0){
        NSLog(@"Searched channel not found");
        
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Search Channel" message:@"Channel not found." preferredStyle:UIAlertControllerStyleAlert];
