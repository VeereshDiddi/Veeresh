...
/**
 * Enable or disable log to console </summary>
 * <p>
 * This method should be called before <see cref="OCOctoStatic::createOctoshapeSystem:messageFilePath:"/>.
 * (What it really does is to preload values for some parameters to
 * the internal <see cref="OCOctoshapeSystem"/> constructor that are not used except
 * for debugging purposes).
 * </p>
 *  @param enableLogging, indicates whether logging to console should be enabled
 */
+(void) enableLogToConsole:(BOOL)enableLogging;
...
/**
 * Enable or disable log to file</summary>
 * <p>
 * This method should be called before <see cref="OCOctoStatic::createOctoshapeSystem:messageFilePath:"/>.
 * (What it really does is to preload values for some parameters to
 * the internal <see cref="OCOctoshapeSystem"/> constructor that are not used except
 * for debugging purposes).
 * </p>
 *  @param enableLogging, indicates whether logging to file should be enabled
 */
+(void) enableLogToFile:(BOOL)enableLogging;
 ...
 *  @param enableLogging, indicates whether logging to file should be enabled
 */
+(void) enableLogToServer:(BOOL)enableLogging;
