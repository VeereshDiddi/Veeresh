...
- (void)viewDidLoad {
    ...
    packageDictImages = [NSDictionary dictionaryWithObjectsAndKeys:
    ...
    packageDictLinks = [NSDictionary dictionaryWithObjectsAndKeys:
                        [NSMutableArray arrayWithObjects:
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch4/auto",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch5/auto",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch12/auto",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch46/auto",
                         nil],
                        @"Games.jpeg",
                        ...
                        [NSMutableArray arrayWithObjects:
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch4/auto",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch5/auto",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch35/1600k",
                         @"octoshape://streams.octoshape.net/ideabytes/live/ib-ch51/auto",
                         nil],
                        @"English.jpeg",
    ...
    packageDictGroups = [NSDictionary dictionaryWithObjectsAndKeys:
                         [NSMutableArray arrayWithObjects:
                          @"news",
                          @"sports",
                          @"music",
