...
-(BOOL)checkNetworkConnection {
    ...
    hostReachable = [Reachability reachabilityWithHostName:@"http://www.apple.com/"];
...
-(void)firstMethodToLaunch {
    
//    if (success.boolValue) {
    
    BOOL reached = [self checkNetworkConnection];
    ...
    if (reached==YES) {
       ...
       // NSLog(@"network available");
        ...
        [self octoshapeStreamCalled:@"octoshape://streams.octoshape.net/ideabytes/live/ib-ch3-1/auto"];
        [self LaunchView];
...
-(void)LaunchView
{
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
    {
        ...
        self.launcherView.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"Launch_1024x768.png"]];
