...
//    NSData *resultData = [NSData dataWithContentsOfURL:[NSURL URLWithString:@"https://www.google.co.in"]];
//    
//    NSUInteger dataLength = resultData.length;
//    
//    NSLog( @"data length %lu",(unsigned long)dataLength);
//    
//    NSLog(@"Data in MB: %.2u",(dataLength/(1024*1024)));
    
    [self checkForNetWorkConnection];
    
    if(_octoshapeSystem != nil) [_octoshapeSystem resume];
